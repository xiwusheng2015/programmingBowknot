...
- java导师，从高级程序员到架构师  | <https://www.cnblogs.com/JavaArchitect/>
...
## 面试实战
- 无重复字符的最长子串，最长不重复子串  
- 最长公共子序列  | <https://mp.weixin.qq.com/s/70ZkfsApVtLV0Oa-j1AL4w>
...
- bigo
- 到 hr 面的：阿里、美团、滴滴、金山云、每日一淘、火币、宜信、旺店通、黄包车、linkedMe==小米，京东，头条，爱奇艺，有赞，
...
面试回顾知识模块：
数据结构和算法，redis，消息队列，TCP/IP，
多线程(AQS,synchronized,ReentrantLock)，
设计模式，
MySQL,Spring,jvm，

大数据的： hive, spark，flume, kafka, hadoop, Hbase, ELK
